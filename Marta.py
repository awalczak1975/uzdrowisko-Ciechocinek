...
# ==========================================================
# 1. KONFIGURACJA I STYLIZACJA (WERSJA ZBALANSOWANA)
# ==========================================================
...
st.markdown("""
    ...
    /* ETYKIETA ZALOGOWANEGO - POWRÓT DO WYRAŹNEJ FORMALNOŚCI */
    .user-info-footer {
    ...
    /* KAFELKI ZADAŃ - ZBALANSOWANA WYSOKOŚĆ */
    .term-box { 
        background: #334155; 
        padding: 12px 10px; 
        border-radius: 6px; 
    ...
    with tabs[i]:
        ...
        if not df_raw.empty:
            ...
            def apply_icon(row):
                ...
                return f"{('🔥 ' if row['DNI_N'] >= -2 else '🟢 ')}{row['TREŚĆ ZADANIA']}"
